...
/*aproach 1 using links interchange
class Solution

{
    ...
    Node *copyList(Node *head)
    {
        ...
        //step2 changing nodes
        
        Node* originalNode = head;
        Node* cloneNode = cloneHead;
        while(originalNode!=NULL&&cloneNode!=NULL){
            Node* nt = originalNode->next;
        ...
        //step3 point randoms to copied ll
        temp = head;
        while(temp!=NULL){
            if(temp->next!=NULL){
...
class Solution
{
    ...
    {
        //Write your code here
        //step 1 create clone linkedList
        Node* cloneHead = NULL;
        Node* cloneTail = NULL;
        Node* temp = head;
        while(temp!=NULL){
        ...
        //step 2 crate a map and copy random links
